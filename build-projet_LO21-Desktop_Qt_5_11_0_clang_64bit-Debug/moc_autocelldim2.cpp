/****************************************************************************
** Meta object code from reading C++ file 'autocelldim2.h'
**
...
#include "../projet_LO21/autocelldim2.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'autocelldim2.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(5, 41, 7), // "boucler"
QT_MOC_LITERAL(6, 49, 8), // "etat_rnd"
QT_MOC_LITERAL(7, 58, 11), // "stop_thread"
QT_MOC_LITERAL(8, 70, 10), // "export_xml"
QT_MOC_LITERAL(9, 81, 11) // "charger_xml"

    },
    "AutoCellDim2\0cellActivation\0\0index\0"
    "simul\0boucler\0etat_rnd\0stop_thread\0"
    "export_xml\0charger_xml"
};
...
void AutoCellDim2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->boucler(); break;
        case 3: _t->etat_rnd(); break;
        case 4: _t->stop_thread(); break;
        case 5: _t->export_xml(); break;
        case 6: _t->charger_xml(); break;
        default: ;
        }
    }
}
